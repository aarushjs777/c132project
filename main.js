...
classifier= ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/QQyi8j8Bh/model.json',modelLoaded);
...
function gotResult(error, results){
 ...
 if(results[0].label == "no_Mask"){
    document.getElementById("update_emoji").innerHTML = "&#x26d4";
 }
 if(results[0].label == "proper_mask"){
